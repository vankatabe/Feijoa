...
@echo unnecessary row copy Blog.UI.Tests\TestResult-Prio=1.xml packages\SpecFlow.2.1.0\tools\TestResult-Prio=1.xml
...
@echo unnecessary row copy "Blog.UI.Tests\TestResult-Prio=2.xml" "packages\SpecFlow.2.1.0\tools\TestResult-Prio=2.xml"
...
@echo unnecessary row copy Blog.UI.Tests\TestResult-Prio=3.xml packages\SpecFlow.2.1.0\tools\TestResult-Prio=3.xml
...
@echo unnecessary row copy Blog.UI.Tests\TestResult.xml packages\SpecFlow.2.1.0\tools\TestResult.xml
